...
$name5 = $_GET[name5];
$sql = "select * from PEOPLE where Name='$name5' ";
...
//function exitnum2($num1){
  if($peopleinfo[5]==0){
    if($num1==1){
      ...
      $sql3 = "update PEOPLE set ExitNum = '1' where Name='$name5';";
      ...
      $sql3 = "update PEOPLE set ExitNum = '2' where Name='$name5';";
      $result2 = mysql_query($sql3, $connect);
    }
    else if($num1==3){
      ...
      $sql3 = "update PEOPLE set ExitNum = '3' where Name='$name5';";
      $result2 = mysql_query($sql3, $connect);
    }
    else if($num1==4){
      ...
      $sql3 = "update PEOPLE set ExitNum = '4' where Name='$name5';";
      $result2 = mysql_query($sql3, $connect);
    }
    else if($num1==5){
      ...
      $sql3 = "update PEOPLE set ExitNum = '5' where Name='$name5';";
      $result2 = mysql_query($sql3, $connect);
    }
    else if($num1==6){
      ...
      $sql3 = "update PEOPLE set ExitNum = '6' where Name='$name5';";
      $result2 = mysql_query($sql3, $connect);
    }
    else if($num1==7){
      ...
      $sql3 = "update PEOPLE set ExitNum = '7' where Name='$name5';";
      $result2 = mysql_query($sql3, $connect);
    }
    else if($num1==8){
      ...
      $sql3 = "update PEOPLE set ExitNum = '8' where Name='$name5';";
      $result2 = mysql_query($sql3, $connect);
    }
    else if($num1==9){
      ...
      $sql3 = "update PEOPLE set ExitNum = '9' where Name='$name5';";
      $result2 = mysql_query($sql3, $connect);
    }
    else if($num1==10){
      ...
      $sql3 = "update PEOPLE set ExitNum = '10' where Name='$name5';";
      $result2 = mysql_query($sql3, $connect);
    }
    else if($num1==11){
      ...
      $sql3 = "update PEOPLE set ExitNum = '11' where Name='$name5';";
      $result2 = mysql_query($sql3, $connect);
    }
    else if($num1==12){
      ...
      $sql3 = "update PEOPLE set ExitNum = '12' where Name='$name5';";
      $result2 = mysql_query($sql3, $connect);
    }
    echo "<script>alert(\"선택하신 출구는 ".$num1."번 출구입니다.\");</script>";
  }
  if($peopleinfo[5]==$num1){  
    ...
    $sql3 = "update PEOPLE set ExitNum = $num1 where Name='$name5';";
    $result2 = mysql_query($sql3, $connect);
    if($num1==1){
      $sql2 = "update STRUCTURE set ExitOne = ExitOne + 1;" ;
      $result = mysql_query($sql2, $connect);
...
<script>
  location.href='mapinfophp.php?name=<?=$name5?>';
</script>
